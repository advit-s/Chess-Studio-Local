// Generated from src\lib\ocrModelContract.ts. Do not edit this file directly.
...
export function modelTileToGridIndex(tileIndex) {
 ...
 */
export function rgbaToModelTiles(rgba, boardSize) {
...
function assertShape(shape, expected, outputName) {
...
function emptyRecognition(scoreKind) {
    return {
        grid: Array(64).fill('empty'),
        scores: Array(64).fill(null),
        margins: Array(64).fill(null),
        topCandidates: Array(64).fill(null),
        scoreKind,
    };
}
export function decodeProbabilityScores(values, shape) {
...
export function decodeClassPredictions(values, shape) {
    assertShape(shape, [64], 'OCR prediction');
    if (values.length !== 64)
        throw new Error(`OCR prediction output has ${values.length} values; expected 64.`);
